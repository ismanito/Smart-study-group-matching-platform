    ...
    <div className="min-h-screen bg-slate-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-3xl rounded-3xl bg-white p-10 shadow-xl shadow-slate-200">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-4xl font-bold text-slate-900">Sign in to StudyMatch</h1>
          <p className="mt-3 text-slate-600">Access your groups, matching tools, and schedule in one place.</p>
        </div>
